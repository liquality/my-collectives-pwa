...
export class AuthService {
  ...
  public static async loginWithPublicAddress(
    ...
    if (user) {
      const decodedAddress = ethers.utils.verifyMessage("By signing, you are proving you own this wallet and logging in. This does not initiate a transaction or cost any fees. Nonce: " + user.nonce, signature);
