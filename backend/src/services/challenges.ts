...
export class ChallengesService {
  public static async create(
    ...
    const tokenData = await fetchReservoirData(
      mintingContractAddress,
      network,
      tokenId
    );
    ...
    try {
      const result = await dbClient("challenges").insert(insertObject, [
        "id",
        "mintingContractAddress",
        "chainId",
        "tokenId",
  ...
  public static async update(challenge: Challenge): Promise<Challenge | null> {
    ...
    try {
      ...
      try {
        const result = await dbClient("challenges")
          .update(insertObject, [
            "id",
            "mintingContractAddress",
            "chainId",
  ...
  private static findChallengeSelect = [
    "challenges.id",
    "mintingContractAddress",
    "chainId",
    "tokenId",
  ...
  public static async findAll(): Promise<any[] | null> {
    const challenges = await dbClient("challenges")
      .select(...this.findChallengeSelect)
